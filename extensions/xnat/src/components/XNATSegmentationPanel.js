...
/**
 * XNATSegmentationPanel component
 *
 * @param {Object} props
 ...
 * @returns component
 */
const XNATSegmentationPanel = ({ studies, viewports, activeIndex }) => {
  return <div className="labelmap-container">TODO SEGMENTATIONS</div>;
};

XNATSegmentationPanel.propTypes = {
  /*
...
XNATSegmentationPanel.defaultProps = {};

export default XNATSegmentationPanel;
