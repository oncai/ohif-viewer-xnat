 ...
 * @returns component
 */
const XNATContoursPanel = ({ studies, viewports, activeIndex }) => {
  return <div className="labelmap-container">TODO CONTOURS</div>;
};

XNATContoursPanel.propTypes = {
  /*
...
XNATContoursPanel.defaultProps = {};

export default XNATContoursPanel;
